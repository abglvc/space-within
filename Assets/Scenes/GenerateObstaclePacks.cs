...
public class GenerateObstaclePacks : MonoBehaviour {
    ...
    public void ButtonGenerate() {
        ...
        switch (dific) {
            case DFC.HARD:
                obstTypeProbability = new[] {0.25f, 0.5f, 0.75f, 1f};
                break;
            case DFC.MEDIUM:
                obstTypeProbability = new[] {0.3f, 0.6f, 0.9f, 1f};
                break;
            case DFC.EASY:
                obstTypeProbability = new[] {0.3f, 0.6f, 0.8f, 1f};
                break;
            default:
                obstTypeProbability = new[] {0.25f, 0.5f, 0.75f, 1f};
                break;
    ...
    private void SpawnEntity(Transform t, ObstaclePack obstaclePack, bool isShort) {
        ...
        for(int i=0; i<obstTypeProbability.Length; i++)
            if (random <= obstTypeProbability[i]) {
                obstType = i;
                break;
            }
        ...
        switch (obstType) {
            ...
            case 2: //pickups
                ...
                randomInt = Random.Range(0, pickups.Length - (!healSpawned && Random.value<0.5f ? 0:1));
                ...
                break;
            case 3: //enemies
                randomInt = Random.Range(0, enemies.Length);
