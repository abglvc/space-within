    ...
    public class ObstaclePack : MonoBehaviour {
        ...
        private void AttachObstacles() {
            ...
            for (int i = 0; i < obstacleInfo.Count; i++) {
                ...
                if (o != null) {
                    ...
                    if (o.OBSTACLE_INDEX == 0) {
                        o.GetComponent<SpriteRenderer>().flipX = flipTop;
                        flipTop = !flipTop;
                    }
                    else if (o.OBSTACLE_INDEX == 15) {
                        o.GetComponent<SpriteRenderer>().flipX = flipBot;
                        flipBot = !flipBot;
                    }
        ...
        private void DeactivateAttachedObstacles() {
            foreach (var o in attachedObstacles)
                if (o != null && obstaclePackId == o.CallerId && o.ActiveObstacle)
                    o.ActiveObstacle = false;
        }
        ...
        private void Initialize() {
            ...
            foreach (Transform child in transform) {
                ...
                child.gameObject
                    .SetActive(false); //(krijem ih i nosim njihov info) ih jer su mi potrebni samo da preuzmem info, a postoje in a first place radi vizualizacije paketa
            }
