...
namespace Controllers {
    public abstract class GameController : MonoBehaviour {
        ...
        protected void Initialize() {
            ...
            StartCoroutine(UserInterface.sng.StartModeInfo(
                dao.data.isLevel ? "LEVEL " + (dao.data.loadedLevel.level + 1) : "FREERUN",
        ...
        public abstract float Difficulty(bool completionCheck=false);
